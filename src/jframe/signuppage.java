...
public class signuppage extends javax.swing.JFrame {
    ...
    public signuppage() {
              ...
              pst.setString(2,pwd);
                pst.setString(3,email);
                 ...
                 if(UpdatedRowCount>0){
                     JOptionPane.showMessageDialog(this , "Recorded inseerted successfully");
                     LoginPage  page= new LoginPage();
                     page.setVisible(true);
                     this.dispose();
                 }else{
                     JOptionPane.showMessageDialog(this , "Recorded inseerted Failure");
     ...
     public boolean validateSignup(){
         ...
         String contact=txt_contact.getText();
          ...
          if(name.equals("")){
                     JOptionPane.showMessageDialog(this , "Pleasse enter username");
                     return false; 
                 }
           if(pwd.equals("")){
                     JOptionPane.showMessageDialog(this , "Pleasse enter password");
                     return false; 
                 }
            if(email.equals("")  || !email.matches("^.+@.+\\..+$")){
                     JOptionPane.showMessageDialog(this , "Pleasse enter valid email");
                     return false; 
                 }
             if(contact.equals("")){
                     JOptionPane.showMessageDialog(this , "Pleasse enter contact");
                     return false; 
                 }
             return true;
     }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 830));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 60, 50));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 200, 30));
        ...
        jPanel1.add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 280, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Username");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 190, 80, 30));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 280, 80, 30));
        ...
        jPanel1.add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 310, 280, -1));
        ...
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 60, 50));

        jLabel19.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Email");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, 80, 30));
        ...
        jPanel1.add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 410, 280, -1));
        ...
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 390, 60, 50));

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(255, 255, 255));
        jLabel21.setText("Contact");
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 480, 80, 30));
        ...
        jPanel1.add(txt_contact, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 510, 280, -1));
        ...
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 490, 60, 50));
        ...
        jPanel1.add(rSMaterialButtonCircle1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 680, 340, 80));
        ...
        jPanel1.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, 340, 80));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 0, 470, 830));
